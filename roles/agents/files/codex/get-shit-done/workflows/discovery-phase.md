...
See $HOME/.codex/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.codex/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.codex/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.codex/get-shit-done/templates/discovery.md
...
Use $HOME/.codex/get-shit-done/templates/discovery.md.
