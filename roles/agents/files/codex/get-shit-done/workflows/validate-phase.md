...
AGENT_SKILLS_AUDITOR=$(node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-nyquist-auditor 2>/dev/null)
```
...
**State B (create):**
1. Read template from `$HOME/.codex/get-shit-done/templates/VALIDATION.md`
...
node "$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
